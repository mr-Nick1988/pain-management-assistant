  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        update: "bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500",
        cancel: "bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500",
        submit: "bg-indigo-600 text-white hover:bg-indigo-700 focus:ring-indigo-500",
        delete: "bg-red-700 text-white hover:bg-red-800 focus:ring-red-600",
      },
      size: {
