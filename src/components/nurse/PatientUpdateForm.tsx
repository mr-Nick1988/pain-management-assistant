...
const PatientUpdateForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setShowSuccess(true);
            setTimeout(() => {
                navigate(`/nurse/patient/${params.mrn}`, {state: {patient: {...patient, ...formData}}});
            }, 1500);
        } catch (error) {
        ...
        <div className="p-6">
            ...
            >
                ...
                <FormFieldWrapper label="Additional Info">
                    <Input type="text" name="additionalInfo" value={formData.additionalInfo || ""}
                           onChange={handleChange}/>
                </FormFieldWrapper>
                <div className="flex items-center gap-2">
                    <input type="checkbox" name="isActive" checked={formData.isActive || false}
                           onChange={handleChange}/>
